...
import fr.echoes.lab.ksf.cc.extmanager.projects.ui.ProjectDashboardExtensionManager;
...
/**
 * The Class ProjectController handles all views related to the projects.
 *
 * @author rgalerme
 */
@Controller
public class ProjectController {
	...
	public ModelAndView createProject(@Valid @ModelAttribute("project") final SFProjectDTO newProject,
			final BindingResult _result) {
	...
	public void handlePageNotFoundException(final Exception e) {
		...
		LOGGER.error("Project was not found {}", e);
	}

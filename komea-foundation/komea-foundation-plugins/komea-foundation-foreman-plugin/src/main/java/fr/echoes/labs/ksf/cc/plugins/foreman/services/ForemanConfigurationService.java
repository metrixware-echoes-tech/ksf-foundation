...
public class ForemanConfigurationService {
	...
	private PluginPropertyStorage propertyStorage;
	private KomeaFoundationContext foundation;
	
	private ForemanConfigurationBean configuration;
	
	@Autowired
	public ForemanConfigurationService(final PluginFramework pluginFramework, final KomeaFoundationContext foundation) {
		this.foundation = foundation;
		this.propertyStorage = pluginFramework.getPluginPropertyStorage();
	}
	
	public ForemanConfigurationBean getConfigurationBean() {
		
		if (this.configuration == null) {
			this.configuration = this.propertyStorage.readPluginProperties(ForemanPlugin.ID, ForemanConfigurationBean.class);

...
/**
 * The Class FolderNodeTypeRestController defines the controller that handlers the types of folder nodes.
 */
@RestController
...
public class FolderNodeTypeRestController {
	...
	public FolderNodeType delete(@PathVariable final String typeID) {

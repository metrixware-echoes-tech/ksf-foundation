...
public class UserDetailsRetrievingService implements UserDetailsService, IReadonlyService,  IAuthenticatedUserService, AuthenticationUserDetailsService<CasAssertionAuthenticationToken> {
	...
	public UserDetailsRetrievingService(final IUserDAO _userService, final IRoleDAO _roleService, final LdapUserConverterService _ldapUserConverterService) {
		...
		this.ldapUserConverterService = _ldapUserConverterService;
	}

	public UserDetailsRetrievingService(Set<String> adminList) {
		this.admins = adminList;
		this.userService = null;
		this.roleService = null;
		this.ldapUserConverterService = null;
	}
	...
	public UserDto getCurrentUser() {
		...
		try {
			...
			if (principal instanceof String) {
				...
				return this.ldapUserConverterService.convertLdapUserDetailsIntoDatabaseUser((LdapUserDetails) principal);
